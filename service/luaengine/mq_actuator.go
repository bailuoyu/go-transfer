...
func DoMQOps(input map[string]interface{}, previous map[string]interface{}, req *model.RowRequest, rule *global.Rule) ([]*model.MQRespond, error) {
	L := _pool.Get()
	defer _pool.Put(L)
	...
	L.SetGlobal(_globalACT, lua.LString(req.Action))
